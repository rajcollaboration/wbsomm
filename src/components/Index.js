...
import toImage from '../assets/images/IMG-20201203-WA0070.jpg'
                            ...
                            <from >
                                ...
                                <Box className={classes.datefldspace}>
                                    ...
                                    <Paper className={classes.paper}>
                                        ...
                                        <Box spacing={4}>
                                            <FormControl className={classes.formControl, classes.spacing}>
                                                <InputLabel htmlFor="district-native-helper">District</InputLabel>
                                                <NativeSelect
                                                    variant="standard"
                                                    inputProps={{
                                                        name: 'district',
                                                        id: 'district-native-helper',
                                                    }}
                                                    onChange={HandleInput}
                                                >
                                            ...
                                            <FormControl className={classes.formControl, classes.spacing}>
                                                <InputLabel htmlFor="block-native-helper">Block</InputLabel>
                                                <NativeSelect

                                                    inputProps={{
                                                        name: 'block',
                                                        id: 'block-native-helper',
                                                    }}
                                                    onChange={HandleInput}
                                                >
                                                    <option aria-label="None" value="" />
                                            ...
                                            <FormControl className={classes.formControl, classes.spacing}>
                                                <InputLabel htmlFor="years-native-helper">Years</InputLabel>
                                                <NativeSelect

                                                    inputProps={{
                                                        name: 'years',
                                                        id: 'years-native-helper',
                                                    }}
                                                    onChange={HandleInput}
                                                >
                                                    <option aria-label="None" value="" />
